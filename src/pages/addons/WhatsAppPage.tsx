...
const FEATURES = [
  'Envio de comprobantes al instante',
  'Notificaciones automaticas a clientes',
  'Mensajes programados y plantillas',
  'Catalogo de productos compartible'
]
    ...
    <Stack gap={6}>
      ...
      <Box style={{
        ...
        <Flex justify="space-between" align="center">
          <Text size="sm" fw={700} c="white">WhatsApp</Text>
        ...
        <Box style={{
          ...
          <Box style={{ padding: '16px 20px', borderBottom: '1px solid #f0f0f0' }}>
            <Text size="sm" c="dark.5" ta="center" style={{ lineHeight: 1.6 }}>
              Conecta tu negocio con WhatsApp Business para automatizar
              la comunicacion con tus clientes y enviar comprobantes al instante.
            </Text>
          </Box>
              ...
              {FEATURES.map((feat) => (
                <Group key={feat} gap={10} wrap="nowrap">
                  <Box style={{
                    ...
                    height: 20,
                    borderRadius: '50%',
                    background: 'linear-gradient(135deg, #86efac 0%, #25d366 100%)',
                    display: 'flex',
                    alignItems: 'center',
          ...
          <Box style={{
            ...
            <Badge size="lg" variant="light" color="green" mb={10}>Requiere Plan PRO</Badge>
            <br />
