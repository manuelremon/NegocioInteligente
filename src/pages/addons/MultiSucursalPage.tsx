    ...
    <Stack gap={6}>
      ...
      <Box style={{
        ...
        <Flex justify="space-between" align="center">
          <Text size="sm" fw={700} c="white">Multi-sucursal</Text>
        ...
        <Box style={{
          ...
          <Box style={{
            ...
            <Text size="xs" c="rgba(255,255,255,0.75)" mt={4}>
              Gestion multi-sede centralizada
            </Text>
          </Box>
          ...
          <Box style={{ padding: '16px 20px', borderBottom: '1px solid #f0f0f0' }}>
            <Text size="sm" c="dark.5" ta="center" style={{ lineHeight: 1.6 }}>
              Gestiona multiples sucursales desde una sola plataforma.
              Inventario, reportes y usuarios centralizados para toda tu cadena.
            </Text>
          </Box>
