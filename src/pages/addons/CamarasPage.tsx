...
const FEATURES = [
  'Monitoreo en vivo desde el POS',
  'Grabacion continua y por eventos',
  'Alertas inteligentes de movimiento',
  'Soporte multi-camara simultaneo'
]

export default function CamarasPage(): JSX.Element {
  return (
    <Stack gap={6}>
      {/* Header */}
      <Box style={{
        ...
        <Flex justify="space-between" align="center">
          <Text size="sm" fw={700} c="white">Camaras de Seguridad</Text>
        ...
        <Box style={{
          ...
          <Box style={{
            ...
            <Text size="xs" c="rgba(255,255,255,0.75)" mt={4}>
              Vigilancia integrada en tu POS
            </Text>
          </Box>
          ...
          <Box style={{ padding: '16px 20px', borderBottom: '1px solid #f0f0f0' }}>
            <Text size="sm" c="dark.5" ta="center" style={{ lineHeight: 1.6 }}>
              Vigila tu negocio directamente desde el punto de venta. Monitoreo
              de camaras de seguridad integrado en la aplicacion.
            </Text>
          </Box>
